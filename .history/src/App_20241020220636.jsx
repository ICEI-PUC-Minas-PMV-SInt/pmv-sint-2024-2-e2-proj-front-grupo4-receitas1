...
export function App() {
	return (
		<div className='main'>
			...
			{/* <Comentarios receitaId={receitas[2].id} /> */}
			<ReceitaEComentarios
				fotoReceita={receitas[2].fotoReceita}
				nome={receitas[2].nome}
				id={receitas[2].id}
				fotoUsuarioPostador={receitas[2].fotoUsuarioPostador}
				usuarioPostador={receitas[2].usuarioPostador}
			/>
		</div>
	);
}
