	...
	return (
		<>
			<div className={styles.containerGeral}>
				{/* Bem-vindo, Adicionar Receita e Suas Receitas Salvas */}
				<div className={styles.containerBemVindoEReceitas}>
					<div className={styles.bemVindoAdicionarReceitas}>
						<div className={styles.bemVindoTexto}>
							<h2>Bem-vindo(a), {user.name}!</h2>
						</div>
						<div className={styles.containerAdicionarReceita}>
							<div className={styles.containerAdicionarReceitaIcone}>➕</div>
							<button
				...
				{/* Coluna da esquerda com Perfil e Preferências */}
				<div className={styles.perfilContent}>
					<div className={styles.colunaPerfilPreferencias}>
