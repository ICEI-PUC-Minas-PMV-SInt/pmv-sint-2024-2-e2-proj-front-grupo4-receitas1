...
const PerfilUsuario = () => {
	...
	// Atualiza receitas filtradas e aplica alterações no avatar para receitas do usuário
	useEffect(() => {
		...
		const receitasAtualizadas = todasReceitas.map(receita => {
			// Atualiza o avatar apenas para receitas do usuário logado
