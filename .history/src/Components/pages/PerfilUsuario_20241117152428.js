...
const PerfilUsuario = () => {
	...
	return (
		<>
			<div className={styles.containerBemVindoSalvarAlteracoesAdicionarReceita}>
			...
			<div className={styles.perfilContainer}>
				{/* Layout principal com coluna da esquerda e receitas à direita */}
