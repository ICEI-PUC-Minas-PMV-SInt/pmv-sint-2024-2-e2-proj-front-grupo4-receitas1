...
const AdicionarReceita = () => {
	...
	useEffect(() => {
		...
		const updateReceitasRecomendadas = () => {
			...
			// Selecionar receitas aleatórias
		...
		// Atualizar receitas recomendadas a cada 10 segundos
		updateReceitasRecomendadas();
		const intervalId = setInterval(updateReceitasRecomendadas, 10000);
