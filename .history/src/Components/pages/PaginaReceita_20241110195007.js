...
const PaginaReceita = () => {
	...
	// Carrega o estado salvo de curtidas e receitas salvas ao montar o componente
	useEffect(() => {
		window.scrollTo(0, 0);
	...
	// Atualiza as recomendações de receitas
	useEffect(() => {
		if (receita) {
	...
	const handleLike = () => {
		...
		// Salva o novo estado de curtida no localStorage
