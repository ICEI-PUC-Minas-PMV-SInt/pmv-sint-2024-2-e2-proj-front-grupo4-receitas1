...
const PaginaReceita = () => {
	...
	useEffect(() => {
		...
		// Combinar receitas estáticas com as receitas do localStorage
		...
		if (receitaEncontrada) {
			...
			setReceitasRecomendadas(
				receitasDaMesmaCategoria.sort(() => Math.random() - 0.5).slice(0, 8)
			);
		}
	}, [id]);
	...
	// Atualizar a foto do usuário postador se for a receita do usuário atual
