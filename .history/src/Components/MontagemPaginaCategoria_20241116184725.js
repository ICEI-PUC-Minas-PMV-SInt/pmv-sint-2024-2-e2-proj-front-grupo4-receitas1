...
const MontagemPaginaCategoria = ({
	...
	// Ajustar a preferência selecionada para se alinhar com o formato de ListaReceitas
	const preferenciasSelecionadas = tipoRefeicao
		? { Categorias: [tipoRefeicao.toLowerCase()] } // Alinhar ao nome da categoria usada em ListaReceitas
		: {}; // Caso nenhuma preferência seja especificada
