...
export function App() {
	return (
		<div className='main'>
			...
			<ReceitaEComentarios
				fotoReceita={receitas[11].fotoReceita}
				nome={receitas[11].nome}
				id={receitas[11].id}
				fotoUsuarioPostador={receitas[11].fotoUsuarioPostador}
				usuarioPostador={receitas[11].usuarioPostador}
			/>
		</div>
	);
}
