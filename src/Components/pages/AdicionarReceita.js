...
const AdicionarReceita = () => {
	...
	const [modoPreparo, setModoPreparo] = useState(''); // Campo Modo de Preparo
	...
	const handleSalvarReceita = () => {
		if (
			!nome ||
			!modoPreparo || // Verifica se o modo de preparo está preenchido
		...
		const novaReceita = {
			...
			nome,
			ingredientes,
			modoPreparo, // Adiciona o modo de preparo na nova receita
			fotoReceita: foto,
